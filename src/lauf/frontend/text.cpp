...
struct inst_fiber_start
{
    static constexpr auto rule  = LAUF_KEYWORD("fiber_start");
    static constexpr auto value = inst(&lauf_asm_inst_fiber_start);
};
    ...
    static constexpr auto rule = [] {
        ...
        auto single
            = dsl::p<inst_return> | dsl::p<inst_jump>                                      //
              ...
              | dsl::p<inst_fiber_create> | dsl::p<inst_fiber_start>                       //
