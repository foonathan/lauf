...
// Save a field from a type, constant is lauf_type*.
// value addr => value
LAUF_BC_OP(save_field, bc_inst_field_constant_idx)
...
// Save a stack value to a constant address.
// value => value
LAUF_BC_OP(save_value, bc_inst_constant)
